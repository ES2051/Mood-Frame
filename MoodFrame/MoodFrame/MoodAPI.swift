...
final class MoodAPI {
    ...
    /// Public tunnel to `app.py` running on the Mac (via cloudflared). Works over any network.
    var baseURL = URL(string: "https://defined-seed-staffing-peninsula.trycloudflare.com")!
